function Lker=modBolaQuadObjKernelLegendreNew(A, GramMatrix, Z, labels, isigma, Lambda)
...
for k=1:K
    ...
    for ik=1:Ck
        ...
        for j=1:N
            ...
            dataSum = dataSum + ( Z(ind(ik))* A(j,k)*gaussianKernel(xj,xik, isigma) + (0.5*Z(ind(ik))^2));
