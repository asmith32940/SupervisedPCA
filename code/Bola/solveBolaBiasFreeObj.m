function WOptimal = solveBolaBiasFreeObj(w0, classDataSets, labels)
...
[newCost, classVarianceMatrices]=bolaBiasFreeObj(w0, classDataSets, labels); %Intial evaluation
f(1) = newCost;
...
while(1)
    ...
    prevCost = newCost;
    newCost=bolaBiasFreeObj(wNew, classDataSets, labels); %Intial evaluation
    f(nn+1) =newCost;    
